...
class HomeRepository
    ...
    constructor(
        ...
        /**
         * Recommendation seeds for personalized Quick Picks: the most-played
         * valid YouTube tracks, falling back to recents, then to remote music
         * history when the local library has nothing usable. Returns at most
         * [limit] seeds, de-duplicated by primary artist so one artist cannot
         * dominate the radio.
         */
        ...
        /**
         * Up Next / related songs for one [seed], with cascading fallbacks:
         * radio (next + related) → song search → cached related songs. Never
         * returns the seed itself, local tracks, or malformed entries.
         */
        ...
        private fun Song.isYouTubeRecommendationSeed(): Boolean =
            !song.isLocal && id.length == YOUTUBE_VIDEO_ID_LENGTH
