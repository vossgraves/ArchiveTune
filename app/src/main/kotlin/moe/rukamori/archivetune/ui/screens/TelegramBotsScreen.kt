...
fun TelegramBotsScreen(navController: NavController) {
    ...
    Scaffold(
        ...
        Column(
            ...
            // position regardless of whether the list is empty or contains bots. Without weight(1f)
            // on the empty branch, the empty-state Box would collapse to its content height and the
            // pill would jump down when a bot is added.
            if (!isReady) {
                Box(
