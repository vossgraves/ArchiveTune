...
import moe.rukamori.archivetune.constants.PreloadLowDataModeKey
    ...
    constructor(
        ...
        suspend fun updateSettings(
            ...
            context.dataStore.edit { preferences ->
                ...
                preferences[PreloadLowDataModeKey] = updatedSettings.lowDataModeEnabled
        ...
        private fun settingsFromPreferences(preferences: Preferences): PlaybackPerformanceSettings =
            PlaybackPerformanceSettings(
                lowDataModeEnabled = preferences[PreloadLowDataModeKey] ?: false,
                preloadNextSongEnabled = preferences[PreloadNextSongKey] ?: false,
                hasPersistedValue =
                    preferences.asMap().containsKey(PreloadLowDataModeKey) ||
