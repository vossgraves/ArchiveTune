...
import app.atf.media.extensions.*
...
import app.atf.media.canvas.AppleMusicProvider
...
import app.atf.media.ui.screens.settings.ThemePalettes
import app.atf.media.ui.theme.ThemeSeedPalette
import app.atf.media.ui.theme.ThemeSeedPaletteCodec
...
import app.atf.media.utils.ProxyUtils
import app.atf.media.utils.YTPlayerUtils
import app.atf.media.utils.clearPlaybackAuthSession
import app.atf.media.utils.clearPlaybackWebAuthSession
import app.atf.media.utils.dataStore
import app.atf.media.utils.get
import app.atf.media.utils.potoken.BotGuardTokenGenerator
import app.atf.media.utils.reportException
import app.atf.media.utils.toPlaybackAuthState
...
class App :
    ...
    private fun initializeCriticalSync() {
        ...
        PaxsenixLyrics.logger = { message ->
            app.atf.media.utils.GlobalLog.append(
        ...
        runCatching { app.atf.media.telegram.TelegramClient.ensureStarted(this) }
    ...
    override fun newImageLoader(context: PlatformContext): ImageLoader {
        ...
        return ImageLoader
            .Builder(this)
            .components {
                add(app.atf.media.telegram.TelegramThumbnailFetcher.Factory())
