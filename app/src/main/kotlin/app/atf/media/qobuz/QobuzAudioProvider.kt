...
object QobuzAudioProvider {
     ...
     * [app.atf.media.tidal.TidalAudioProvider.CandidateMetadata].
     */
     ...
     * [app.atf.media.tidal.TidalAudioProvider.searchCandidates].
     *
    ...
    fun searchCandidates(
        ...
        if (tokens.isEmpty()) {
            val poolTokens = runCatching {
                app.atf.media.utils.PoolAccountManager.qobuzAccounts().map {
                    QobuzToken(
                        token = it.token,
                        appId = it.appId,
