...
import app.atf.media.constants.QueueEditLockKey
...
import app.atf.media.ui.component.MediaMetadataListItem
...
import app.atf.media.utils.oem.SystemMediaControlResolver
...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is app.atf.media.together.TogetherSessionState.Joined &&
            (togetherSessionState as app.atf.media.together.TogetherSessionState.Joined).role is app.atf.media.together.TogetherRole.Guest
                                                    ...
                                                    onClick = {
                                                        if (selection) {
                                                            ...
                                                            if (index == currentWindowIndex) {
                                                                ...
                                                                val joined =
                                                                    togetherSessionState as? app.atf.media.together.TogetherSessionState.Joined
                                                                val isGuest = joined?.role is app.atf.media.together.TogetherRole.Guest
                                                                if (isGuest) {
