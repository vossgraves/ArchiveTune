...
import app.atf.media.logcat.LogcatLevel
import app.atf.media.ui.utils.backToMain
import app.atf.media.viewmodels.LogcatEffect
import app.atf.media.viewmodels.LogcatScreenState
import app.atf.media.viewmodels.LogcatUiEntries
import app.atf.media.viewmodels.LogcatUiEntry
import app.atf.media.viewmodels.LogcatUiModel
import app.atf.media.viewmodels.LogcatViewModel
import app.atf.media.ui.component.IconButton as ArchiveTuneIconButton
...
fun LogcatScreen(
    ...
    LaunchedEffect(Unit) {
        app.atf.media.utils.GlobalLog.flush()
    }
