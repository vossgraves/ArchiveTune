...
import app.atf.media.constants.DiscordActivityButton1CustomUrlKey
import app.atf.media.constants.DiscordActivityButton1EnabledKey
import app.atf.media.constants.DiscordActivityButton1LabelKey
import app.atf.media.constants.DiscordActivityButton1UrlSourceKey
import app.atf.media.constants.DiscordActivityButton2CustomUrlKey
import app.atf.media.constants.DiscordActivityButton2EnabledKey
import app.atf.media.constants.DiscordActivityButton2LabelKey
import app.atf.media.constants.DiscordActivityButton2UrlSourceKey
import app.atf.media.constants.DiscordActivityDetailsKey
import app.atf.media.constants.DiscordActivityNameKey
import app.atf.media.constants.DiscordActivityPlatformKey
import app.atf.media.constants.DiscordActivityStateKey
import app.atf.media.constants.DiscordActivityTypeKey
import app.atf.media.constants.DiscordLargeImageCustomUrlKey
import app.atf.media.constants.DiscordLargeImageTypeKey
import app.atf.media.constants.DiscordLargeTextCustomKey
import app.atf.media.constants.DiscordLargeTextSourceKey
import app.atf.media.constants.DiscordPresenceStatusKey
import app.atf.media.constants.DiscordSmallImageCustomUrlKey
import app.atf.media.constants.DiscordSmallImageTypeKey
import app.atf.media.constants.EnableTranslatorKey
import app.atf.media.constants.TranslatorContextsKey
import app.atf.media.constants.TranslatorTargetLangKey
import app.atf.media.db.entities.Song
import app.atf.media.discord.DiscordActivityPlatform
import app.atf.media.telegram.isTelegramMediaId
import app.atf.media.discord.DiscordActivityType
import app.atf.media.discord.DiscordOnlineStatus
import app.atf.media.discord.DiscordPresenceActivity
import app.atf.media.discord.DiscordPresenceAssets
import app.atf.media.discord.DiscordPresenceButton
import app.atf.media.discord.DiscordPresenceTimestamps
import app.atf.media.discord.DiscordSocialPresenceClient
import app.atf.media.discord.DiscordStatusDisplayType
