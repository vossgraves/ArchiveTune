...
import app.atf.media.ui.component.LyricsShareImageOptions
import java.io.File
...
object ComposeToImage {
    ...
    suspend fun createLyricsImage(
        ...
        glassStyle: app.atf.media.ui.component.LyricsGlassStyle? = null,
        shareOptions: LyricsShareImageOptions = LyricsShareImageOptions(),
    ): Bitmap =
        withContext(Dispatchers.Default) {
            val style = glassStyle ?: app.atf.media.ui.component.LyricsGlassStyle.FrostedDark
