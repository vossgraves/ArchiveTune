...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: app.atf.media.together.JoinDecision,
    ) : TogetherClientEvent

    data class HostTransferred(
        val transfer: app.atf.media.together.HostTransferred,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: app.atf.media.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is app.atf.media.together.JoinDecision -> {
                            ...
                            is app.atf.media.together.HostTransferred -> {
                                if (message.sessionId == sessionId) {
